...
<p align="center">
  <strong>Collaborative terminal + playbook workspace for penetration testing engagements</strong>
</p>
...
![Riptide — Active engagement workspace with playbooks, credentials, and terminal](docs/screenshot.png)
